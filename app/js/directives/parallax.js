    ...
    link: function($scope, elem, attrs) {
      var setPosition = function () {
        ...
        if (calcValY <= $window.innerHeight) {
          ...
          var hozVal = ($scope.parallaxHorizontalOffset.indexOf("%") === -1 ? $scope.parallaxHorizontalOffset + '%' : $scope.parallaxHorizontalOffset);
  ...
  return {
    ...
    link: function($scope, elem, attrs) {
      var setPosition = function () {
        ...
        elem.css('background-position', "0%" + calcValY + "%");
      };
